...
public class Withdraw extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Withdrawal Amount");
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        try
        {
            ...
            if(i!=0 && i1!=0)
            {
                JOptionPane.showMessageDialog(null,"Your Money is Successfully Been Withdrawn","Withdraw Money",JOptionPane.INFORMATION_MESSAGE);
            }
            else
            {
                JOptionPane.showMessageDialog(null,"Sorry,Your Money is not been Withdrawn","Error Message",JOptionPane.ERROR_MESSAGE);
            }
        }
        catch(Exception e)
        {
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b3ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement pd=db.con.prepareStatement("select * from image where Account_Number=?");
            pd.setString(1,account_number);
            byte b[]=null;
            db.rs=pd.executeQuery();
            while(db.rs.next())
            {
                b=db.rs.getBytes(3);
            }
